...
import com.weiwoju.kewuyou.Constants.Header;
import com.weiwoju.kewuyou.network.service.AccountService;
import com.weiwoju.kewuyou.network.service.BusinessService;
import com.weiwoju.kewuyou.network.service.ProductService;
...
//    private String mToken;
    ...
    public ApiClient(Context context, File cacheLocation) {
        mContext = context;
...
//                newRequest.addHeader(Header.HTTP_DEVICE_ID, SystemUtil.getDeviceId(mContext));
                ...
                if (mSessionId != null) {
                    newRequest.addHeader(Header.SESSION_ID,mSessionId);
                }
    ...
    public ProductService productService(){
        return getByProxy(ProductService.class);
    }
