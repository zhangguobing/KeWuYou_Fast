...
public class BasicItemViewV extends FrameLayout {
	...
	private void readAttrs(Context context, AttributeSet attrs) {
		if (null != attrs) {
			...
			if (a.hasValue(R.styleable.SettingViewItem_setting_view_arrow)) {
				Drawable drawable = a.getDrawable(R.styleable.SettingViewItem_setting_view_arrow);
				if (null != drawable) {
			...
			if (a.hasValue(R.styleable.SettingViewItem_setting_view_subTitleSize)) {
				int textSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, a.getDimensionPixelSize(R.styleable.SettingViewItem_setting_view_subTitleSize, 14), getResources().getDisplayMetrics());
			...
			if (a.hasValue(R.styleable.SettingViewItem_setting_view_titleSize)) {
				int textSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX, a.getDimensionPixelSize(R.styleable.SettingViewItem_setting_view_titleSize, 16), getResources().getDisplayMetrics());
